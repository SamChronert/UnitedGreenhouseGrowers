...
export class ObjectStorageService {
  ...
  // Gets the upload URL for resource images.
  async getResourceImageUploadURL(): Promise<string> {
    ...
    const fullPath = `${privateObjectDir}/resource-images/${imageId}`;
  ...
  normalizeResourceImagePath(rawPath: string): string {
    ...
    const imageId = rawObjectPath.slice((objectEntityDir + "resource-images/").length);
